...
@ApiModel
@Data
public class PoliceQueryResult extends BaseJson {
    ...
    @ApiModelProperty(value = "报警时间", required = true, example = "2018-03-12 21:32:33")
    @JSONField(format = "yyyy-MM-dd HH:mm:ss")
    private LocalDateTime policeTime;
    
    @ApiModelProperty(value = "设备标识", required = true, example = "sdf334fd")
